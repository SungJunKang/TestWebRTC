...
/**
 * AsyncTask that converts an AppRTC room URL into the set of signaling parameters to use with that room.
 *
 * AppRTC 룸 URL 을 해당 룸에서 사용할 신호 매개 변수 집합으로 변환하는 비동기 작업입니다.
 */

/*
RoomParametersFetcher (필수)
