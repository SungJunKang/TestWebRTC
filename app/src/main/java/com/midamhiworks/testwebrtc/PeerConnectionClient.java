...
import com.midamhiworks.testwebrtc.RecordedAudioToFileController;
...
/*
PeerConnectionClient (필수)

- CallActivity 에서 오디오, 비디오 요소들을 바탕으로 ICE Candidate를 생성하여 데이터(오디오&비디오)를 p2p보내는 클래스 및 인터페이스

- CallActivity 에서 콜백 메소드를 생성함.
 */
